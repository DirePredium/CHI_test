...
public final class ListItemUserBinding implements ViewBinding {
  ...
  private ListItemUserBinding(@NonNull LinearLayout rootView, @NonNull CheckBox checkBoxIsStudent,
      @NonNull TextView textViewAge, @NonNull TextView textViewName) {
  ...
  public static ListItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemUserBinding((LinearLayout) rootView, checkBoxIsStudent, textViewAge,
          textViewName);
    }
